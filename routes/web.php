...
Route::middleware('auth:siteuser')->group(function () {
    ...
    Route::post('/profil/sifre-guncelle', [ProfileController::class, 'updatePassword'])->name('siteuser.profile.updatePassword');
    ...
    Route::post('/profil/guncelle', [ProfileController::class, 'updateInfo'])->name('siteuser.profile.updateInfo');
